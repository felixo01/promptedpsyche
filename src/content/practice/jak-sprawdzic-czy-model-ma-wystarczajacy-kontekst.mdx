...
Przekazanie kontekstu to krótki, sprawdzony zapis aktualnego stanu pracy. Wypełnij szablon na podstawie własnej listy i źródeł, a następnie przeczytaj go przed użyciem.
...
Kolejne ćwiczenie rozwinie przygotowanie pakietu kontekstu do długich projektów.
...
10. **Akceptowanie przekazania napisanego przez model bez sprawdzenia.** Przekazanie kontekstu trzeba porównać z aktualnymi źródłami i decyzjami.
...
- [Okno kontekstu](/pl/concepts/context-window/) opisuje limit tokenów wejściowych i wyjściowych, które model może obsłużyć.
