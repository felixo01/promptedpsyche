...
description: "A practice for separating what can be pointed to in the material from interpretations, assumptions and questions before a conclusion or decision forms."
...
When working with AI, an organized summary can look like a finished conclusion. Facts, interpretations, assumptions and recommendations can blend into one paragraph. This practice helps slow that movement down before a first reading of the situation starts acting like a decision.
...
2. Interpretation: what someone may think it means.
...
- Whether the exercise turns uncertainty into a table that only looks neutral.

## What can go wrong

- The model may wrongly classify an interpretation as a fact.
- A tidy table may create the impression of more certainty and neutrality than actually exists.
...
First separate what can be pointed to from what it may mean. Only then decide which question or action makes sense.
