...
In AI work, that is risky because [model output](/concepts/model-output/) is not the same as knowledge. It is a system's result. It can be useful, accurate and well phrased, but it can also contain simplifications, missing context or claims that sound stronger than their basis.
...
Different tasks need different levels of checking. A draft email is not the same as a data interpretation, a client recommendation or a sentence that will enter a public document. This is why [calibrated trust](/concepts/calibrated-trust/) matters: trust should fit the situation.

## Epistemic vigilance

[Epistemic vigilance](/concepts/epistemic-vigilance/) can be explained simply: it is care with information. It means asking where information comes from, whether it deserves trust, what supports it and what should be checked before it becomes a basis for action.
...
That is why [AI literacy](/concepts/ai-literacy/) is more than asking better questions. It also means not surrendering too quickly to good form.
