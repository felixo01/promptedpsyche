...
Po czwarte, podatność na [antropomorfizację](/pl/concepts/antropomorfizacja/). Im więcej sygnałów przypomina zachowanie społeczne, tym łatwiej dopowiedzieć do nich intencję, charakter, emocję albo "nastawienie".
...
Ucieleśnienie nie usuwa problemu [błędu automatyzacji](/pl/concepts/blad-automatyzacji/). Może go nawet wzmocnić, jeśli forma systemu sugeruje kompetencję większą niż rzeczywista.
