...
description: "Embodied AI does not have to be conscious to change how humans relate to it. On presence, trust, voice, movement and the psychology of Human-Robot Interaction."
...
That is one of the important questions at the intersection of AI, psychology and [Human-AI Interaction](/concepts/human-ai-interaction/): what changes when artificial intelligence stops being only text on a screen and starts appearing as something with voice, motion and physical presence?
...
Fourth, vulnerability to [anthropomorphism](/concepts/anthropomorphism/). The more signals resemble social behavior, the easier it becomes to add intention, character, emotion or attitude to them.
...
<figure class="article-figure">
  <img src="/images/articles/what-changes-when-ai-has-a-body/what-changes-when-ai-has-a-body-conceptual-diagram.png" alt="A conceptual diagram showing five aspects that change when AI has a body: presence, voice, movement, gaze and distance." loading="lazy" decoding="async" />
  <figcaption>A body does not prove consciousness, but it changes the system of signals: presence, voice, movement, gaze and distance begin to work psychologically.</figcaption>
</figure>
...
Embodiment does not remove [automation bias](/concepts/automation-bias/). In some contexts, it may strengthen it, because the form of the system can suggest more competence than the system has.
...
<figure class="article-figure">
  <img src="/images/articles/what-changes-when-ai-has-a-body/screen-based-ai-vs-embodied-ai-comparison.png" alt="A comparison of screen-based AI and embodied AI across presence, nonverbal signals, social pressure, anthropomorphism, trust and responsibility." loading="lazy" decoding="async" />
  <figcaption>This is a conceptual comparison, not numerical data. Embodiment can make AI feel more present, agentic and relational.</figcaption>
</figure>
...
Does it increase trust beyond what is warranted? Does it encourage people to disclose information they would not disclose to an ordinary application? Does it create an impression of care where there is only simulated caring behavior? Does it weaken [human agency](/concepts/human-agency/)? Does it make refusal harder? Does it blur the boundary between support and influence?

<figure class="article-figure">
  <img src="/images/articles/what-changes-when-ai-has-a-body/presence-does-not-mean-consciousness-embodied-ai.png" alt="An infographic explaining that embodied AI can detect and classify signals, but detection does not mean empathy or consciousness." loading="lazy" decoding="async" />
  <figcaption>A system can detect signals and classify patterns. That is not the same as human experience, empathy or responsibility.</figcaption>
</figure>
