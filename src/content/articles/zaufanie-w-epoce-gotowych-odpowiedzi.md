...
inBrief:
  ...
  - "Krytyczne myślenie nie znika po prostu podczas pracy z AI; część tej pracy przesuwa się w stronę weryfikacji, integracji i odpowiedzialnego prowadzenia zadania."
...
Ten esej koncepcyjny oparty na badaniach dotyczy wpływu generatywnej AI na relację między pytaniem, źródłem a poczuciem użytkownika, że coś wie. Jest narracyjną syntezą, a nie przeglądem systematycznym. Łączy badania nad społecznym zaufaniem do nauki, epistemologią społeczną, wyszukiwaniem informacji i generatywnymi wyszukiwarkami, halucynacjami i faktualnością, zaufaniem do automatyzacji, Human-AI Interaction, odciążeniem poznawczym oraz krytycznym myśleniem w pracy wspieranej przez AI. Główna teza brzmi: generatywna AI działa jako pośrednik poznawczy. Ułatwia dostęp do złożonego materiału, ale może przedstawić wynik jako jedną płynną odpowiedź, w której słabiej widać dokumenty, metody, granice dowodów i spory. Ten efekt nazywam opisowo kompresją drogi poznawczej, bez proponowania nowego konstruktu psychologicznego ani teorii naukowej. Badania nad wsparciem cytowań, deklarowanym wysiłkiem krytycznym i nadmiernym poleganiem na automatyzacji pokazują, dlaczego płynność, wyjaśnienia i cytacje nie gwarantują adekwatnego polegania. Praktyczny wniosek nie polega na ogólnym odrzuceniu odpowiedzi AI. Trzeba dopasować poziom zaufania do zadania i stawki, a w sprawach istotnych odtworzyć drogę od twierdzenia do pochodzenia, dowodów, niepewności, sporu i ludzkiej odpowiedzialności.

## Zakres i metoda

Ten tekst jest narracyjną syntezą, nie przeglądem systematycznym. Nie obejmuje wyczerpującej kwerendy, prerejestrowanej strategii wyszukiwania ani ilościowego oszacowania efektów. Zasada doboru była węższa i praktyczna: pierwszeństwo miały recenzowane badania, oficjalne raporty oraz bezpośrednio związane z tematem źródła pierwotne, które pozwalają sprawdzić twierdzenia użyte w eseju.

Materiał pochodzi z kilku pól zadających podobne, lecz nieidentyczne pytania. Badania zaufania publicznego pokazują, jak ludzie oceniają naukowców i instytucje. Epistemologia społeczna analizuje zależność wiedzy od świadectwa innych, ekspertów i organizacji. Badania nad wyszukiwaniem informacji i generatywnymi wyszukiwarkami analizują, czy od odpowiedzi można wrócić do materiału, który ją wspiera. Prace nad [halucynacjami modelu](/pl/concepts/halucynacja-modelu/) i faktualnością sprawdzają wierność wygenerowanego tekstu wobec źródeł. Literatura o automatyzacji i [Human-AI Interaction](/pl/concepts/human-ai-interaction/) koncentruje się na poleganiu na systemie, sygnałach interfejsu i kontroli człowieka. Badania [odciążenia poznawczego](/pl/concepts/cognitive-offloading/) i krytycznego myślenia pomagają opisać, jak zmienia się rozkład wysiłku, gdy narzędzie wykonuje część zadania.
...
Brytyjski raport *Public Attitudes to Science 2025* pokazuje bardziej lokalny i ambiwalentny obraz. Ipsos przebadał 5 281 dorosłych mieszkańców Wielkiej Brytanii między lutym a lipcem 2025 roku na zlecenie UK Research and Innovation i we współpracy z British Science Association. Duże większości nadal ceniły wkład nauki i naukowców. Jednocześnie częściej pojawiały się odpowiedzi neutralne lub niepewne, mniej osób niż w 2019 roku czuło się dobrze poinformowanych, a AI okazała się tematem silnie dzielącym. Raport zaznacza również, że zmiana metody badania utrudnia proste porównywanie wyników w czasie (Ipsos, British Science Association, & UK Research and Innovation, 2026).
...
Wygenerowany akapit może łączyć recenzowaną publikację, raport instytucjonalny, dziennikarstwo, dokumentację firmy, komentarz i stary materiał kontekstowy bez zachowania różnic między nimi. Wszystkie zdania otrzymują tę samą typografię, ton i pozorny status. Czytelnik widzi cytacje, lecz niekoniecznie zauważa, czy kluczowa teza pochodzi z badania pierwotnego, wtórnego omówienia czy źródła mającego interes komercyjny.
...
## Cytacja jest drogą, nie certyfikatem

W 2023 roku Nelson Liu, Tianyi Zhang i Percy Liang przeprowadzili audyt czterech generatywnych wyszukiwarek. W ocenionych odpowiedziach około 51,5% wygenerowanych zdań było w pełni wspartych cytacjami, a około 74,5% cytacji wspierało zdanie, z którym je połączono (Liu, Zhang, & Liang, 2023). Audyt dotyczył określonych systemów w określonym momencie. Nie powinien być powtarzany jako trwały wynik wszystkich współczesnych produktów.

Trwalszy wniosek ma charakter pojęciowy: obecność cytacji nie jest tym samym co oparcie w dowodach. Po zobaczeniu przypisu pozostaje co najmniej siedem pytań:
...
Trzeba rozdzielić zaufanie, poleganie i adekwatne poleganie. Zaufanie jest postawą albo oczekiwaniem wobec systemu. Poleganie jest zachowaniem: użyciem jego wyniku w decyzji lub działaniu. Adekwatne poleganie oznacza, że zachowanie jest rozsądnie dopasowane do rzeczywistych możliwości systemu w danym kontekście. Klasyczna literatura automatyzacji ostrzega zarówno przed nadużyciem wynikającym z nadmiernego polegania, jak i przed zbyt silnym odrzuceniem narzędzia. Ogólne zalecenia „ufaj bardziej” i „ufaj mniej” są równie słabe (Parasuraman & Riley, 1997; Lee & See, 2004).

[Skalibrowane zaufanie](/pl/concepts/calibrated-trust/) zależy od co najmniej siedmiu cech:

1. **Stawka.** Co się stanie, jeśli odpowiedź będzie błędna?
2. **Widoczność źródeł.** Czy można sprawdzić drogę do materiału?
3. **Jakość źródeł.** Czy są pierwotne, aktualne, niezależne i odpowiednie?
4. **Kompetencja użytkownika.** Czy potrafi rozpoznać słabą odpowiedź w tej dziedzinie?
5. **Niezależna weryfikacja.** Czy istnieje inny sposób sprawdzenia tezy?
6. **Odwracalność.** Czy błąd da się naprawić przed wystąpieniem trwałej szkody?
7. **Odpowiedzialność.** Kto musi uzasadnić wynik i odpowiedzieć za konsekwencje?
...
Całego ciężaru nie można przerzucić na czujność pojedynczego użytkownika. Systemy pośredniczące w dostępie do wiedzy powinny zachowywać cytacje na poziomie twierdzeń, rodzaj źródła, datę publikacji, informacje o niepewności i historię wersji. Powinny umożliwiać zakwestionowanie odpowiedzi, sprawdzenie zmian oraz przekazanie istotnego wyniku do przeglądu kompetentnego człowieka. Organizacja potrzebuje zapisu, kto dokonał kontroli, według jakiej zasady i z jaką wiedzą dziedzinową.

Profil NIST dla generatywnej AI jest dobrowolną pomocą w zarządzaniu ryzykiem, a nie wymogiem prawnym. Wśród sugerowanych działań NIST wymienia sprawdzanie wygenerowanych informacji, przegląd i weryfikację źródeł oraz cytacji, śledzenie pochodzenia treści, dokumentowanie udziału ludzkiej wiedzy dziedzinowej, a także ocenę, czy operatorzy i użytkownicy rozumieją pochodzenie oraz historię treści (Autio et al., 2024). Takie środki przenoszą część pracy z osamotnionego czytelnika na system i organizację, które nadają odpowiedzi praktyczne znaczenie.
...
Baza badań nad użyciem generatywnej AI rozwija się szybko. Wynik jednego systemu, wersji produktu albo zadania nie powinien być uogólniany na każdy model i kontekst. Mechanizmy wyszukiwania, interfejsy cytowań i zachowanie modeli zmieniają się w czasie, dlatego audyt generatywnych wyszukiwarek z 2023 roku jest dowodem problemu weryfikacji, a nie aktualnym wynikiem całej branży.
...
Protokół jest ramą analityczną i praktyczną, nie zwalidowanym narzędziem. Może być niepotrzebny przy zadaniach o niskiej stawce i łatwych do odwrócenia, a niewystarczający przy decyzjach zawodowych wymagających uprawnień, formalnego przeglądu albo odpowiedzialności instytucjonalnej.
...
Dojrzała AI literacy oznacza rozpoznanie, kiedy odpowiedź wystarcza, a kiedy trzeba odbudować drogę do dowodów. Nie chodzi o abstrakcyjne zaufanie lub nieufność wobec odpowiedzi. Trzeba dopasować poleganie do zadania, a przy wysokiej stawce odtworzyć drogę.
...
- Ipsos, British Science Association, & UK Research and Innovation. (2026). *Public Attitudes to Science 2025*. https://pas.ipsos.com/
