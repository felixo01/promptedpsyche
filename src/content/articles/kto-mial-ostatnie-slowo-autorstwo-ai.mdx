...
<aside class="editorial-aside editorial-aside--legal-update" data-qa="ai-act-article-50-update">
  <p class="editorial-aside__label">Aktualizacja prawna - obowiązki od 2 sierpnia 2026</p>
  <p><a href="https://eur-lex.europa.eu/legal-content/PL/TXT/?uri=CELEX:32024R1689">Artykuł 50 unijnego AI Act</a> ustanawia obowiązki przejrzystości stosowane od 2 sierpnia 2026 roku. Dostawcy systemów generujących syntetyczne treści audio, obrazy, wideo lub tekst mają zapewnić, by wyniki były oznaczone w formacie nadającym się do odczytu maszynowego i możliwe do wykrycia jako sztucznie wygenerowane lub zmanipulowane. Obowiązek ten nie obejmuje systemów, które jedynie wspomagają standardową edycję albo nie zmieniają istotnie danych wejściowych lub ich znaczenia.</p>
  <p>Objęte przepisem podmioty stosujące systemy AI muszą ujawniać deepfake'i oraz wygenerowany lub zmanipulowany tekst publikowany w celu informowania opinii publicznej o sprawach leżących w interesie publicznym. Dla takiego tekstu obowiązek nie ma zastosowania, gdy treść przeszła weryfikację przez człowieka lub kontrolę redakcyjną i osoba fizyczna lub prawna ponosi odpowiedzialność redakcyjną za publikację. Przy deepfake'ach stanowiących część utworu ewidentnie artystycznego, twórczego, satyrycznego lub fikcyjnego ujawnienie ma nie utrudniać prezentowania ani odbioru utworu. Informacja powinna być jasna, rozpoznawalna i przekazana najpóźniej przy pierwszym kontakcie z treścią.</p>
  <p>Te obowiązki dotyczą przejrzystości, nie ustanawiają prawnego testu autorstwa ani progu udziału AI. <a href="https://digital-strategy.ec.europa.eu/en/library/guidelines-transparency-obligations-providers-and-deployers-ai-systems">Finalne wytyczne Komisji Europejskiej</a> wyjaśniają praktyczne stosowanie art. 50, lecz nie zmieniają tekstu rozporządzenia. Wskazują też wąski okres przejściowy do 2 grudnia 2026 roku dla obowiązków oznaczania i wykrywania dotyczących niektórych systemów generatywnych wprowadzonych na rynek lub oddanych do użytku przed 2 sierpnia 2026 roku.</p>
</aside>
...
<aside class="key-passage" data-qa="closing-passage">
  ...
  <p>AI może wygenerować treść, ale to człowiek powinien mieć ostatnie zdanie - choćby brzmiało ono: „nie, jeszcze raz”.</p>
</aside>
...
16. Unia Europejska (13 czerwca 2024). [Rozporządzenie (UE) 2024/1689 w sprawie sztucznej inteligencji, art. 50 i 113](https://eur-lex.europa.eu/legal-content/PL/TXT/?uri=CELEX:32024R1689). Oficjalny tekst obowiązków przejrzystości i daty ich stosowania.
17. Komisja Europejska (20 lipca 2026). [Finalne wytyczne dotyczące obowiązków przejrzystości dostawców i podmiotów stosujących systemy AI](https://digital-strategy.ec.europa.eu/en/library/guidelines-transparency-obligations-providers-and-deployers-ai-systems). Praktyczne wyjaśnienia stosowania art. 50; wytyczne nie zmieniają rozporządzenia.
